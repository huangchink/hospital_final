"""Sol screen projection: ArUco screen-pose detection + 3D gaze-ray homography.

Pure geometry (cv2 + numpy); no Sol SDK dependency. Extracted verbatim from sol_tracker.py.
"""
import queue
import threading
import time
